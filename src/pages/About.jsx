    ...
    <div>
      ...
      <div className="con2 w-[1440px] h-[969px] mx-auto flex items-center" style={{ backgroundImage: `url(${bg1})` }}>
        <div className='w-[1030px] h-[768px] bg-[white] mx-auto'>
          ...
          <p className='w-[823px] text-[#01AEE7] text-[22px] font-bold ml-[107px] mt-[24px]'>Свяжитесь с нами, чтобы узнать, как партнерство с TRUE может помочь вашей компании добиться успеха.</p>
        </div>
      </div>
